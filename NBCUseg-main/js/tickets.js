...
async function submitNewTicket(){
  ...
  var insertData={ticket_id:tid,subject:sub,body:body||"",asset_id:assetId,status:"open",priority:"medium",created_by_email:currentUser.email||"",created_by_name:currentUser.name||"",visibility:actualVis,target_email:targetEmail};
